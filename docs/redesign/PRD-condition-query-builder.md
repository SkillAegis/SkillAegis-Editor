...
4. **P4 (optional) — hooks for concept ② to pre-fill the slots** from a live sample event. (OQ1 `simulate_ips` sources delivered in the P1 non-MISP fast-follow above.)
